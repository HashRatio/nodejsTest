...
public class BTCData {
	...
	calendar.set(Calendar.HOUR_OF_DAY, Integer.parseInt(dateStr.substring(8,10)));
	calendar.set(Calendar.MINUTE, Integer.parseInt(dateStr.substring(10,12)));
	...
	for(int i=0;i<array.size();i++){
	    ...
	    Record r = new Record(parseHuobiDate(record.get(0).getAsString()),
		    record.get(1).getAsDouble(),
		    record.get(2).getAsDouble(),
		    record.get(3).getAsDouble(),
		    record.get(4).getAsDouble(),
